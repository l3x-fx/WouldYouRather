...
import dummy from "../../assets/ava-dummy.png"
      ...
      <div className="blah">
        <div className="quest-detail">
          ...
          <div className="quest-title">
            <div className="ava qava">
              <img src={users[poll.author].avatarURL || dummy} alt="avatar dummy" />
            </div>
          ...
          <div className="det DoptA">
            {" "}
            <span>A: </span> {poll.optionOne.text}{" "}
          </div>
          <div className="det DoptB">
            {" "}
            <span>B: </span> {poll.optionTwo.text}
          </div>
          <div
          ...
          <div className="statsA" style={{ display: answered ? "block" : "none" }}>
            <div className="resultbarA">
              <div className="resultA" style={{ width: percentageOne() + "%" }}>
                &nbsp;{percentageOne()}%{" "}
              </div>
            </div>
          ...
          <div className="statsB" style={{ display: answered ? "block" : "none" }}>
            <div className="resultbarB">
              <div className="resultB" style={{ width: percentageTwo() + "%" }}>
                &nbsp;{percentageTwo()}%
              </div>
            </div>
          ...
          <button className="btn btnback" onClick={() => navigate("/")}>
            Back
          </button>
        </div>
      </div>
