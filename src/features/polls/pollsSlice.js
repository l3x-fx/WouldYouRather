...
export const getAllPolls = createAsyncThunk("polls/getAllPolls", async () => {
  const response = await _getQuestions()
  return response
})

export const savePollAnswer = createAsyncThunk("polls/savePollAnswer", async ({ authedUser, qid, answer }) => {
  const response = await _saveQuestionAnswer({ authedUser, qid, answer })
  return response
})

export const saveNewPoll = createAsyncThunk("polls/saveNewPoll", async (newPoll) => {
